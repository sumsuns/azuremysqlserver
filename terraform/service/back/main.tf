...
// to fetch the password from azure vault if we dont generate random_password
...
#----------------------------------------------------------------
# Adding  MySQL Server replica creation
#-----------------------------------------------------------------
...
#------------------------------------------------------------
# Adding   backup of Azure SQL database
#------------------------------------------------------------
